...
!function (t) {
    ...
    var e = function (t, e) {
        ...
        var n = {}, r = e.$, g = e.constructorOverride || {button: i, text: m, url: y, email: u, password: l, range: h, textarea: v, select: d, "select[multiple]": s, radio: p, checkbox: a, file: c, "file[multiple]": f, hidden: o}, $ = function (e, i) {
    ...
    return t = t || {}, $(this).each((function () {
        ...
        }, o = a.find("[data-repeater-item]").first().clone().hide(), f = u(u($(this).find("[data-repeater-item]"), t.repeaters).first().find("[data-repeater-delete]"), t.repeaters);
        ...
        var s = function () {
            ...
            t.each((function (t) {
                ...
                r.data("item-name", e + "[" + t + "]"), u(r.find("[name]"), n).each((function () {
                    var i = $(this), a = i.attr("name").match(/\[[^\]]+\]/g), c = a ? last(a).replace(/\[|\]/g, "") : i.attr("name"), o = e + "[" + t + "][" + c + "]" + (i.is(":checkbox") || i.attr("multiple") ? "[]" : "");
